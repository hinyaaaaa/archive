...
function navigateTo(page){
  ...
  // homeを離れる時は必ず先に太陽系シーンを破棄する(WebGLコンテキストの
  // 上限はiOS Safariで特に厳しく、放置すると数回の行き来でエラーになる)。
...
function renderSettings(){
  ...
  return'<div class="page-wrap">'+
    ...
    '<div class="card"><div class="card-header"><span class="card-title">今日のキャパシティ</span></div>'+
      ...
      guide+'</div>'+
    '<div class="card"><div class="card-header"><span class="card-title">恒星系について</span></div>'+
      '<p style="font-size:12px;color:var(--text3);line-height:1.7">「今日」ページの恒星系はタスクの締切と負荷から毎回組み立てられる架空の天体で、実在の太陽系配置ではありません。惑星の質感には<a href="https://www.solarsystemscope.com/textures/" target="_blank" rel="noopener" style="color:var(--accent)">Solar System Scope</a>のテクスチャ(CC BY 4.0)を使用しています。</p>'+
    '</div>'+
