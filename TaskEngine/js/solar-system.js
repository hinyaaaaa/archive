/* ============================================================
   ...
   ------------------------------------------------------------
   TaskEngine本体(通常script、ES5寄りの記法)とは別のtype=moduleとして
...
function loadAllTextures() {
  return fetchTexturesJson().then((src) => new Promise((resolve) => {
...
function attachInteraction() {
  ...
  window.addEventListener('mousemove', function (e) { if (gesture.mode === 'rotate') onPointerMove({ touches: [e] }); });
